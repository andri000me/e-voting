    ...
    function () {
        ...
        var C = c.PR = {
            ...
            prettyPrintOne: c.prettyPrintOne = function (e, t, i) {
                ...
                return n.innerHTML = e, i && o(n, i, !0), h({
                    h: t,
                    j: i,
                    c: n,
                    i: 1
            ...
            prettyPrint: c.prettyPrint = function (e) {
                function t() {
                    for (var i, s = c.PR_SHOULD_USE_CONTINUATION ? u.now() + 250 : 1 / 0; n.length > p && s > u.now(); p++) {
                        ...
                        if (m.test(l) && !g.test(l)) {
                            for (var x = !1, C = a.parentNode; C; C = C.parentNode)
                                if (L.test(C.tagName) && C.className && m.test(C.className)) {
                                    x = !0;
                                    break
                                } if (!x) {
                                ...
                                var w, l = l.match(f);
                                if (x = !l) {
                                    for (var x = a, C = void 0, S = x.firstChild; S; S = S.nextSibling) var O = S.nodeType,
                ...
                for (var i = [document.getElementsByTagName("pre"), document.getElementsByTagName("code"), document.getElementsByTagName("xmp")], n = [], s = 0; i.length > s; ++s)
                    for (var a = 0, l = i[s].length; l > a; ++a) n.push(i[s][a]);
                var i = r,
                    u = Date;
                u.now || (u = {
                    now: function () {
